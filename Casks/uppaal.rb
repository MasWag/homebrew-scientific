cask "uppaal" do
  ...
  name "Uppaal"
  desc "Tool environment for modeling, simulation, and verification of real-time systems"
  ...
  postflight do
    puts "Please register at veriaal.dk for a license key. See https://uppaal.org/downloads/ for details."
  end
